...
public class ResumeTestData {
    public void setContactPhone(Resume currentResume) {
        currentResume.setContact(TypeContact.valueOf("PHONE"), "+7(921) 855-0482");
    }

    public void setContactSkype(Resume currentResume) {
        currentResume.setContact(TypeContact.valueOf("SKYPE"), "userSkype");
    }

    public void setContactEmeil(Resume currentResume) {
        currentResume.setContact(TypeContact.valueOf("EMEIL"), "contact1@mail.ru");
    }


    public void setSectionContacts(Resume currentResume) {
        currentResume.setContact(TypeContact.valueOf("PHONE"), "+7(921) 855-0482");
        currentResume.setContact(TypeContact.valueOf("SKYPE"), "userSkype");
        currentResume.setContact(TypeContact.valueOf("EMEIL"), "contact1@mail.ru");
    }

    public void setSectionPersonal(Resume currentResume) {
        ...
        currentResume.setSection(TypeSection.valueOf("PERSONAL"), personal);
    }

    public void setSectionAchievement(Resume currentResume) {
        ...
        currentResume.setSection(TypeSection.valueOf("ACHIEVEMENT"), achievement);
    }

    public void setSectionQualifications(Resume currentResume) {
        ...
        currentResume.setSection(TypeSection.valueOf("QUALIFICATIONS"), qualifications);
    }

    public void setSectionEducation(Resume currentResume) {
        ...
        currentResume.setSection(TypeSection.valueOf("EDUCATION"), education);
    }

    public void setSectionExperience(Resume currentResume) {
        ...
        OrganizationPeriod experienceWrike = new OrganizationPeriod("Wrike", "",
                Arrays.asList(
                        ...
                        new PositionHeld(YearMonth.of(2016, 2),
                                ...
                                new TextSection("Проектирование и разработка микросерверной инфраструктуры взаимодействия сервисов (JavaScript, Jquerry, Angular, Docker, Kubernetes)"))
                )
        );
        AbstractSection experience = new PeriodSection(Arrays.asList(experienceJavaOnline, experienceWrike));
        currentResume.setSection(TypeSection.valueOf("EXPERIENCE"), experience);
    }
}